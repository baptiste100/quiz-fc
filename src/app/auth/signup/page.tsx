...
export default function SignUp() {
    ...
    return (
        <Card className="bg-[color:var(--div-bg)] border-transparent text-[color:var(--dark-text-color)] flex flex-col z-50 rounded-lg w-120 mt-[5%]">
            <CardHeader>
            ...
            <CardFooter className="flex flex-col text-center text-[color:var(--dark-text-color)]">
